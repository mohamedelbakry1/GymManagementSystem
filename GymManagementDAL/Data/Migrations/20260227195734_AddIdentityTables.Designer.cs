...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20260227195734_AddIdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("CheckEmailValid", "Email like '_%@_%._%'");

                            t.HasCheckConstraint("CheckPhoneValid", "Phone like '01%' and Phone not like '%[^0-9]%'");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("CheckDurationDaysValid", "DurationDays between 1 and 365");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Session", b =>
                {
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            t.HasCheckConstraint("CheckCapacityValid", "Capacity between 1 and 25");
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Trainer", b =>
                {
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            t.HasCheckConstraint("CheckEmailValid", "Email like '_%@_%._%'")
                                .HasName("CheckEmailValid1");

                            t.HasCheckConstraint("CheckPhoneValid", "Phone like '01%' and Phone not like '%[^0-9]%'")
                                .HasName("CheckPhoneValid1");
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GymManagementDAL.Entities.AppUser", null)
                        .WithMany()
