        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckEmailValid", "Email like '_%@_%._%'");
                    table.CheckConstraint("CheckPhoneValid", "Phone like '01%' and Phone not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckDurationDaysValid", "DurationDays between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckEmailValid1", "Email like '_%@_%._%'");
                    table.CheckConstraint("CheckPhoneValid1", "Phone like '01%' and Phone not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckCapacityValid", "Capacity between 1 and 25");
